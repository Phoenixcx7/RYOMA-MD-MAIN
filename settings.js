...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || "RYOMA MD",
    ...
    MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/h3xnpf.jpg",
    // add custom menu and mention reply image url

    ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/h3xnpf.jpg",
    // add img for alive msg

    LIVE_MSG: process.env.LIVE_MSG || 
`> ʙᴏᴛ ɪs sᴘᴀʀᴋɪɴɢ ᴀᴄᴛɪᴠᴇ ᴀɴᴅ ᴀʟɪᴠᴇ

ᴋᴇᴇᴘ ᴜsɪɴɢ ✦RYOMA MD✦ ғʀᴏᴍ RYOMA ᴛᴇᴄʜ ɪɴᴄ⚡

*© ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ - ᴍᴅ*

> ɢɪᴛʜᴜʙ : https://github.com/Phoenixcx7/RYOMA-MD-MAIN`,
    // add alive msg here 

    STICKER_NAME: process.env.STICKER_NAME || "RYOMA MD",
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "50941045133",
    // add your bot owner number

    OWNER_NAME: process.env.OWNER_NAME || "RYOMA",
    // add bot owner name

    DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ RYOMA*",
    ...
    DEV: process.env.DEV || "50941045133",
